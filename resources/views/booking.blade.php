...
<body>
    ...
    <form action="/book_data" method="POST">
        ...
        <fieldset>
            <label>First Name
                <input type="text" name="fname" value="{{session('user')}}" required /></label>
            <label>Last Name
            ...
            <label>Room Name
                <input type="text" name="room_name" value="{{$data['room_name']}}" readonly />
            </label>
            <label>Price
                <input type="text" name="room_price" value="{{$data['price']}}" readonly />
            </label>
            <label>Check-in Date
