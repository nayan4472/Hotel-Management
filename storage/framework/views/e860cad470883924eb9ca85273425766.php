        ...
        <div class="box-root flex-flex flex-direction--column" style="min-height: 100vh;flex-grow: 1;">
            ...
            <div class="box-root padding-top--24 flex-flex flex-direction--column" style="flex-grow: 1; z-index: 9;">
                ...
                <div class="formbg-outer">
                    <div class="formbg" style="margin-top: 170px">
                        <div class="formbg-inner padding-horizontal--48">
                            <span class="padding-bottom--15">Edit Data</span>
                            <form method="post" action="<?php echo e(url('admin/'.$data['id'])); ?>">
                                <?php echo csrf_field(); ?>
                                ...
                                Username :
                                <input type="text" name="username" value="<?php echo e($data['username']); ?>">
                                <br>
                                <br>
                                Email :
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <br>
                                password :
                                <input type="text" name="password" value="<?php echo e($data['password']); ?>">
                                <!-- <p style="color:red">
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <br>
                                Comfirm PassWord :
                                <input type="text" name="cpassword" value="<?php echo e($data['cpassword']); ?>">
                                <p style="color:red">
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <br>
                                Role :
                                <input type="text" name="role" value="<?php echo e($data['role']); ?>">
                                <br>
                                <br>
...
<?php /**PATH C:\xampp\htdocs\Hotel_Managment\resources\views/aedit.blade.php ENDPATH**/ ?>