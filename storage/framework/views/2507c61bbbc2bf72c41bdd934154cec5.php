            ...
            <tbody>
                <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $in): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr class="head1">
                        ...
                        <td><button><a href="delete_booking/<?php echo e($in->id); ?>">Cancel</a></button></td>
                    </tr>
...
<?php /**PATH C:\xampp\htdocs\Hotel_Managment\resources\views/my_booking.blade.php ENDPATH**/ ?>