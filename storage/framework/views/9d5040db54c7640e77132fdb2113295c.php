                ...
                <div class="formbg-outer">
                    <div class="formbg" style="margin-top: 170px">
                        <div class="formbg-inner padding-horizontal--48">
                            ...
                            <form id="stripe-login" method="post" action="/edit_room">
                                <?php echo csrf_field(); ?>
                                ...
                                <div class="field padding-bottom--24">
                                    ...
                                    <input type="file" name="nimg_name" value="<?php echo e($data['img_name']); ?>">
                                </div>
                                <div class="field padding-bottom--24">
                                    <label>Email</label>
                                    <input type="text" name="nroom_name" value="<?php echo e($data['room_name']); ?>">
                                </div>
                                <div class="field padding-bottom--24">
                                    <div class="grid--50-50">
                                        <label for="password">Price</label>
                                    </div>
                                    <input type="text" name="nprice" value="<?php echo e($data['price']); ?>">
                                </div>
                                <div class="field padding-bottom--24">
...
<?php /**PATH C:\xampp\htdocs\Hotel_Managment\resources\views/update_img.blade.php ENDPATH**/ ?>