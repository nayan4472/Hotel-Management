...
<head>
    ...
    <style>
        body {
            ...
            background-image: url(<?php echo e(url('img/h3.jpg')); ?>);
        }
...
<body>
    <div class="main">
        ...
        <div class="signup">
            ...
            <form class="box" action="<?php echo e(url('admin')); ?>" method="POST">
                <?php echo csrf_field(); ?>
...
<?php /**PATH C:\xampp\htdocs\Hotel_Managment\resources\views/index.blade.php ENDPATH**/ ?>